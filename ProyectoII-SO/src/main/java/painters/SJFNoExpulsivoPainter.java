 ...
 * @author diego
 */
public class SJFNoExpulsivoPainter extends javax.swing.JPanel {
    ...
    public SJFNoExpulsivoPainter(int[][] matriz, int tamañoRectanguloAncho, int tamañoRectanguloAlto,
