 ...
 * @author diego
 */
public class FCFSPainter extends javax.swing.JPanel {
...
private int[][] matriz; // La matriz con los valores de los rectángulos  ok la matriz con los valores de ejemplo
    ...
    public FCFSPainter(int[][] matriz, int tamañoRectanguloAncho, int tamañoRectanguloAlto,
                    ...
                    if (i < currentRow || (i == currentRow && j <= currentCol)) {
                        ...
                        if (i < procesos.size()) {
                            ...
                            if (contador == procesos.size()) {
                                ...
                                g.setColor(Color.BLACK);
                                g.drawString("El algoritmo FCFS ha terminado, diagrama completo", 400, startY + 250 + ii);
