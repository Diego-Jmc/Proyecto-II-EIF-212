 ...
 * @author diego
 */
public class SJFExpulsivoPainter extends javax.swing.JPanel {
    ...
    public SJFExpulsivoPainter(int[][] matriz, int tamañoRectanguloAncho, int tamañoRectanguloAlto,
